...
export declare class LuckyExcel {
    constructor();
    ...
    static transformExcelToUniver(excelFile: File, callback?: (files: IWorkbookData, fs?: {
        raw: string;
        chunks: any;
    }) => void, errorHandler?: (err: Error) => void): void;
    static transformCsvToUniver(file: File, callback?: (files: IWorkbookData, fs?: {
        full: string[][];
        chunks: string[][][];
    }) => void, errorHandler?: (err: Error) => void): void;
